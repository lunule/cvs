 ...
 */
class Clearviewsys_Rates_Table_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 
			$this->plugin_name, 
			plugin_dir_url( __FILE__ ) . 'css/cvs-ratestable-public.css', 
			null,
			$this->version, 
			'all' 
		);
	...
	public function enqueue_scripts() {
		...
		wp_register_script( 
			$this->plugin_name, 
			plugin_dir_url( __FILE__ ) . 'js/cvs-ratestable-public.js', 
			array( 'jquery' ), 
			$this->version, 
			true 
		);
		...
		$translation_array = array(
			...
			'xmlUrl' 			=> CVS_RATES_TABLE_XML_URL,			
			'imgsUrl' 			=> CVS_RATES_TABLE_IMGS_URL,			
		);
		wp_localize_script( $this->plugin_name, 'cvsRatestable', $translation_array );
