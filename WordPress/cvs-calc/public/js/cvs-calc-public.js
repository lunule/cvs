...
(function( $ ) {
	...
	$.fn.cvsCalc = function(options){
		...
		return this.each(function() {
			...
			const data_ibuy 		= $(this).data('ibuy'),
				  data_isell 		= $(this).data('isell'),
				  data_youpay 		= $(this).data('youpay'),
				  data_youreceive 	= $(this).data('youreceive'),
			...
			options.calcLabels['youReceive'] 	= ( data_youreceive && ( '' !== data_youreceive ) )
													? data_youreceive
													: 'You Receive';
